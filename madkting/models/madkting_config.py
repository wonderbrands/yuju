...
class MadktingConfig(models.Model):
    ...
    orders_unconfirmed_by_ff_type = fields.Boolean('Order unconfirmed Fulfillment', help='Valida el tipo de fulfillment ordenes antes de confirmar')
    orders_unconfirmed_stock_src = fields.Char(string="Stock Src Sales", help='Ubicaciones de stock para validar stock en ventas')
    orders_unconfirmed_ff_types = fields.Char(string="Tipos de Fulfillment", help='Tipos de Fulfillment para validar ventas')
